...
public class Cadastro {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (op < 0 || op > optotal)
				...
				case 2:
					ArrayList <Anuncio> resultado = c.pesquisa(lista,false);
				...
				case 4:
					resultado = c.pesquisa(lista, true);
					if (resultado.isEmpty()) {
	...
	public ArrayList <Anuncio> pesquisa(ArrayList <Anuncio> lista, boolean aux) {
		int op=1;
